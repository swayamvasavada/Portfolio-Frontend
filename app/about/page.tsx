    ...
    <main className="min-h-screen pt-32 pb-24 px-6 max-w-7xl mx-auto">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
        ...
        <div className="relative w-full max-w-md mx-auto lg:mx-0">
          ...
          <div className="relative aspect-[4/5] rounded-3xl bg-slate-900/80 backdrop-blur-xl border border-slate-700 overflow-hidden shadow-2xl flex items-center justify-center group">
             <div className="w-32 h-32 rounded-full border border-slate-600 bg-slate-800 flex items-center justify-center mb-4 group-hover:scale-105 transition-transform duration-500">
               <span className="text-slate-500 text-sm">Your Photo</span>
             </div>
             
             <div className="absolute top-4 right-4 w-20 h-6 bg-slate-800/50 backdrop-blur-md border border-slate-700 rounded-full flex items-center px-2 gap-2">
